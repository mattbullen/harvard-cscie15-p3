                    ...
                    <div id="result" class="nano-content">
                        <div id="description">
                            ...
                            <div id="description-content">
                                <p class="description-content-paragraph">Use the slider in the menu to the left to select the number of random users to generate. The generator defaults to one user, but you can select up to twenty.</p>
